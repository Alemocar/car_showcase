          ...
          <div className="fixed inset-0 overflow-auto">
            <div className="flex min-h-full items-center justify-center p-4 text-center">
              <Transition.Child
                ...
                <Dialog.Panel
                  className={
                    'relative flex max-h-[90vh] w-full max-w-lg transform flex-col gap-5 overflow-auto rounded-2xl bg-white p-6 text-left shadow-xl transition-all'
                  }>
                  <button
                    type="button"
                  ...
                  <div className="flex flex-1 flex-col gap-2">
                    ...
                    <div className="mt-3 flex  flex-wrap gap-4">
                      {Object.entries(car).map(([key, value]) => (
                        <div
                          className="text-rigth flex w-full justify-between gap-5"
                          key={key}>
